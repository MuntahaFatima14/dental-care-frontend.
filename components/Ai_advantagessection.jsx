    ...
    <section className="bg-[#dce7ea] py-16 px-6 md:px-16">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
          Advantages of AI-Enhanced Disease Detection
        </h2>
        <p className="max-w-3xl mx-auto text-gray-700 leading-relaxed">
          Experience the cutting-edge advancements in care through our AI
          technology for detecting diseases. Our innovative solution enables
          proactive health management ensuring early identification of issues
          and prompt intervention.
        </p>
      </div>

      <div className="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-20 max-w-6xl mx-auto">
        {/* Left Text */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-2xl">
          <div className="text-center sm:text-left">
            <h4 className="font-semibold text-lg mb-2 text-gray-900">Early Detection</h4>
            <p className="text-gray-600 text-sm">
              AI Disease Detection identifies issues at early stages, enabling
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-gray-600 text-sm">
              AI Disease Detection is suitable for children, adults, and seniors
