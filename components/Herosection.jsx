    ...
    <section className="flex flex-col md:flex-row items-center justify-between bg-[#dce7ea] px-6 md:px-24 py-12 md:py-32 hero-section">
      ...
      <div className="max-w-xl mb-10 md:mb-0">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6 leading-snug">
          AI-Driven Cavity Detection For Optimal Oral Health
        </h1>
        <p className="text-gray-700 mb-8 leading-relaxed">
          Transform dentistry using AI Cavity Detection, revolutionizing
        ...
        <button className="bg-white text-gray-900 font-semibold py-3 px-8 rounded-full shadow hover:bg-gray-100 transition duration-300">
          Get Started
        </button>
      </div>
